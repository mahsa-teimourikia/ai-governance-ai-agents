...
1. [NIST — Role-Based Access Control project and INCITS 359 history](https://csrc.nist.gov/projects/role-based-access-control)
2. [NIST SP 800-162 — Guide to Attribute Based Access Control](https://csrc.nist.gov/pubs/sp/800/162/upd2/final)
3. [Zanzibar: Google’s Consistent, Global Authorization System](https://www.usenix.org/conference/atc19/presentation/pang)
4. [OpenFGA — Authorization for Agents](https://openfga.dev/docs/modeling/agents)
5. [OpenFGA — Task-Based Authorization](https://openfga.dev/docs/modeling/agents/task-based-authorization)
6. [OpenFGA — Agents as Principals](https://openfga.dev/docs/modeling/agents/agents-as-principals)
7. [OpenFGA — Contextual Tuples](https://openfga.dev/docs/interacting/contextual-tuples)
8. [OpenFGA Python SDK releases](https://github.com/openfga/python-sdk/releases)
9. [Cedar Policy Language](https://docs.cedarpolicy.com/)
10. [Cedar authorization semantics](https://docs.cedarpolicy.com/auth/authorization.html)
11. [Cedar policy validation](https://docs.cedarpolicy.com/policies/validation.html)
12. [Cedar releases](https://github.com/cedar-policy/cedar/releases)
13. [Open Policy Agent documentation](https://www.openpolicyagent.org/docs)
14. [OPA Rego policy language](https://www.openpolicyagent.org/docs/policy-language)
15. [OPA decision logs and masking](https://www.openpolicyagent.org/docs/management-decision-logs)
16. [OPA releases](https://github.com/open-policy-agent/opa/releases)
17. [Amazon Verified Permissions](https://docs.aws.amazon.com/verifiedpermissions/)
18. [Amazon Bedrock AgentCore Policy](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/policy.html)
19. [AgentCore Policy core concepts](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/policy-core-concepts.html)
20. [AgentCore Policy permissions](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/policy-permissions.html)
21. [AutoCedar research preprint](https://arxiv.org/abs/2607.03656)
22. [Prose2Policy research preprint](https://arxiv.org/abs/2603.15799)
23. [FAVA research preprint](https://arxiv.org/abs/2607.27267)
